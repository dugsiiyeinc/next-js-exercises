            ...
            <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <form action={formAction}>
                    ...
                    <div className="flex gap-3">
                        <button
                            type="submit"
                            className="flex-1 cursor-pointer bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
                        >
                            Create Todo
                        </button>
